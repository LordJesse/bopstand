...
const float pArray[24] PROGMEM = {1, 0.9854, 0.971, 0.9566, 0.9424, 0.9283, 0.9143, 0.9004, 0.8866, 0.8729, 0.8593, 0.7932, 0.7299, 0.6694, 0.6117, 0.5567, 0.5450, 0.4962, 0.4400, 0.3902, 0.3460, 0.3068, 0.2721, 0.2413};
...
void dispALT() {
  ...
  oled.drawImage(alt_img, 18, 0, 66, 3);
...
void dispTAS() {
  ...
  oled.drawImage(spd_img, 18, 3, 66, 6);
...
void setup()
{
  ...
  delay(1000);
  oled.drawImage(BoP_Logo, 0, 0, 128, 8);
  delay(4000);
  displayUp();
