...
class SSD1306_Mini {
  ...
  public:
    ...
    // print a single Small character
    void printCharS(int xpos, int ypos, char ch );

     // print a single Large character
    void printCharL(int xpos, int ypos, char ch );
    
    // print a Small string to the screen
    void printStringS(int xst, int yst,  char * pText );

    // print a Large string to the screen
